...
def log_accuracy_to_json(json_path: str, input_file: str, accuracy: float):
...
def run_evaluation(args):
    ...
    # Log accuracy into a file
    acc_log_path = os.path.join(args.output_folder, 'acc_log.json')
    log_accuracy_to_json(acc_log_path, args.input_file, accuracy)
